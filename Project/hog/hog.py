...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    i, score, sad = 0, 0, False

    while i < num_rolls:
        roll = dice()
        if roll == 1:
            sad = True
        score, i = score + roll, i + 1
    if sad:
        return 1
    return score
    # END PROBLEM 1
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    return lambda player_score, opponent_score: n
    # END PROBLEM 6
...
def make_averaged(original_function, times_called=1000):
    ...
    def average(*args):
        ...
        while i < times_called:
            accum += original_function(*args)
            i += 1
        return accum / times_called
